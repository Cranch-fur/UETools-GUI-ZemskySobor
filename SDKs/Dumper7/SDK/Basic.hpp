...
namespace Offsets
{
	constexpr int32 GObjects          = 0x090839B0;
	constexpr int32 AppendString      = 0x00D8E090;
	constexpr int32 GNames            = 0x08FDD580;
	constexpr int32 GWorld            = 0x091F1BC8;
	constexpr int32 ProcessEvent      = 0x00F4D060;
