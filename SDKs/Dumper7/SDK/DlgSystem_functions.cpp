...
bool UDlgConditionCustom::IsParticipantRequired()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("DlgConditionCustom", "IsParticipantRequired");

	Params::DlgConditionCustom_IsParticipantRequired Parms{};
...
bool UDlgDialogue::IsParticipantsOptional() const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("DlgDialogue", "IsParticipantsOptional");

	Params::DlgDialogue_IsParticipantsOptional Parms{};
