...
// ScriptStruct NNE.NNEModelRaw
// 0x0018 (0x0018 - 0x0000)
struct FNNEModelRaw final
{
public:
	TArray<uint8>                                 Data;                                              // 0x0000(0x0010)(Edit, ZeroConstructor, EditConst, NativeAccessSpecifierPublic)
	ENNEInferenceFormat                           Format;                                            // 0x0010(0x0001)(Edit, ZeroConstructor, EditConst, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_11[0x7];                                       // 0x0011(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
DUMPER7_ASSERTS_FNNEModelRaw;
...
public:
	...
	TArray<uint8>                                 TensorData;                                        // 0x0020(0x0010)(Edit, ZeroConstructor, EditConst, NativeAccessSpecifierPublic)
};
