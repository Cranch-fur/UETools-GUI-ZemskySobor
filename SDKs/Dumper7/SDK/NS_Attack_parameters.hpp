...
struct NS_Attack_C_GetNotifyName final
{
public:
	class FString                                 ReturnValue;                                       // 0x0000(0x0010)(Parm, OutParm, ZeroConstructor, ReturnParm, HasGetValueTypeHash)
};
DUMPER7_ASSERTS_NS_Attack_C_GetNotifyName;

// Function NS_Attack.NS_Attack_C.Received_NotifyBegin
// 0x00A0 (0x00A0 - 0x0000)
struct NS_Attack_C_Received_NotifyBegin final
{
public:
	...
	bool                                          CallFunc_AddLooseGameplayTags_ReturnValue;         // 0x0098(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
DUMPER7_ASSERTS_NS_Attack_C_Received_NotifyBegin;

// Function NS_Attack.NS_Attack_C.Received_NotifyEnd
// 0x0098 (0x0098 - 0x0000)
struct NS_Attack_C_Received_NotifyEnd final
{
public:
	class USkeletalMeshComponent*                 MeshComp;                                          // 0x0000(0x0008)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	class UAnimSequenceBase*                      Animation;                                         // 0x0008(0x0008)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
...
DUMPER7_ASSERTS_NS_Attack_C_Received_NotifyEnd;
