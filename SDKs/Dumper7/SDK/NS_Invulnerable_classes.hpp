...
// BlueprintGeneratedClass NS_Invulnerable.NS_Invulnerable_C
// 0x0000 (0x0030 - 0x0030)
class UNS_Invulnerable_C final : public UAnimNotifyState
{
public:
...
public:
	...
	{
		BP_STATIC_CLASS_IMPL("NS_Invulnerable_C")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"NS_Invulnerable_C")
	}
	static class UNS_Invulnerable_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<UNS_Invulnerable_C>();
	}
};
DUMPER7_ASSERTS_UNS_Invulnerable_C;
