...
struct NS_SendGameplayEventAtEnd_C_GetNotifyName final
{
public:
	class FString                                 ReturnValue;                                       // 0x0000(0x0010)(Parm, OutParm, ZeroConstructor, ReturnParm, HasGetValueTypeHash)
};
DUMPER7_ASSERTS_NS_SendGameplayEventAtEnd_C_GetNotifyName;

// Function NS_SendGameplayEventAtEnd.NS_SendGameplayEventAtEnd_C.Received_NotifyBegin
// 0x0050 (0x0050 - 0x0000)
struct NS_SendGameplayEventAtEnd_C_Received_NotifyBegin final
{
public:
...
DUMPER7_ASSERTS_NS_SendGameplayEventAtEnd_C_Received_NotifyBegin;

// Function NS_SendGameplayEventAtEnd.NS_SendGameplayEventAtEnd_C.Received_NotifyEnd
// 0x0050 (0x0050 - 0x0000)
struct NS_SendGameplayEventAtEnd_C_Received_NotifyEnd final
{
public:
	class USkeletalMeshComponent*                 MeshComp;                                          // 0x0000(0x0008)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	class UAnimSequenceBase*                      Animation;                                         // 0x0008(0x0008)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
...
DUMPER7_ASSERTS_NS_SendGameplayEventAtEnd_C_Received_NotifyEnd;
