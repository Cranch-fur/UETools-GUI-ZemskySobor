...
struct NS_SetWeaponVisibility_C_Received_NotifyBegin final
{
public:
	...
	class UEquipmentComponent*                    CallFunc_GetComponentByClass_ReturnValue;          // 0x0058(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_IsValid_ReturnValue_1;                    // 0x0060(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
DUMPER7_ASSERTS_NS_SetWeaponVisibility_C_Received_NotifyBegin;

// Function NS_SetWeaponVisibility.NS_SetWeaponVisibility_C.Received_NotifyEnd
// 0x0068 (0x0068 - 0x0000)
struct NS_SetWeaponVisibility_C_Received_NotifyEnd final
{
public:
	class USkeletalMeshComponent*                 MeshComp;                                          // 0x0000(0x0008)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	class UAnimSequenceBase*                      Animation;                                         // 0x0008(0x0008)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
...
DUMPER7_ASSERTS_NS_SetWeaponVisibility_C_Received_NotifyEnd;
