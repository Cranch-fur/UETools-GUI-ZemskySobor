...
struct SendGameplayEvent_AN_C_GetNotifyName final
{
public:
	class FString                                 ReturnValue;                                       // 0x0000(0x0010)(Parm, OutParm, ZeroConstructor, ReturnParm, HasGetValueTypeHash)
};
DUMPER7_ASSERTS_SendGameplayEvent_AN_C_GetNotifyName;

// Function SendGameplayEvent_AN.SendGameplayEvent_AN_C.Received_Notify
// 0x0060 (0x0060 - 0x0000)
struct SendGameplayEvent_AN_C_Received_Notify final
{
public:
...
DUMPER7_ASSERTS_SendGameplayEvent_AN_C_Received_Notify;
