...
struct TestWidget_C_ExecuteUbergraph_TestWidget final
{
public:
	...
	class ULoadLevelButton_C*                     CallFunc_Create_ReturnValue;                       // 0x0028(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
...
DUMPER7_ASSERTS_TestWidget_C_ExecuteUbergraph_TestWidget;
