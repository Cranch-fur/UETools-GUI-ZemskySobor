...
class UI_TabButton::UUI_TabButton_C final : public UUserWidget
{
public:
	...
	class UUI_PhotoMode_C*                        PhotoModeWidgetRef;                                // 0x02D8(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, InstancedReference, NoDestructor, HasGetValueTypeHash)
...
public:
	...
	static class UI_TabButton::UUI_TabButton_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<UI_TabButton::UUI_TabButton_C>();
	}
};
DUMPER7_ASSERTS_UI_TabButton__UUI_TabButton_C;
