...
// Function Weather_Mask_Projection_Box.Weather_Mask_Projection_Box_C.Draw Mask
// (BlueprintCallable, BlueprintEvent)

void AWeather_Mask_Projection_Box_C::Draw_Mask()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("Weather_Mask_Projection_Box_C", "Draw Mask");
