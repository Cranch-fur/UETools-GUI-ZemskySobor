...
public:
	...
	class ABP_Ultra_Dynamic_Weather_C*            CallFunc_GetActorOfClass_ReturnValue;              // 0x0250(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class ABP_Ultra_Dynamic_Weather_C*            CallFunc_GetActorOfClass_ReturnValue_1;            // 0x0258(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
