...
// class ABP_Ultra_Dynamic_Sky_C*          UDS                                                    (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
...
void AWeather_Override_Volume_C::Custom_Volume_Behavior(double Alpha, class ABP_Ultra_Dynamic_Sky_C* UDS, class ABP_Ultra_Dynamic_Weather_C* UDW_0)
{
	static class UFunction* Func = nullptr;
...
void AWeather_Override_Volume_C::Update_Volume_Color(class ABP_Ultra_Dynamic_Weather_C* UDW_0)
{
	static class UFunction* Func = nullptr;
