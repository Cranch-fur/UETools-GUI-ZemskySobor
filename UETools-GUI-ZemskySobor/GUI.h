...
namespace Features
{
	...
	public:
		...
		static inline std::vector<Smuta::QuestState::DataStructure> activeQuests;
		static inline std::vector<Smuta::QuestState::DataStructure> finishedQuests;
		static inline std::vector<Smuta::QuestState::DataStructure> trackingQuests;
